...
public class Formatting {
    public static void main(String[] args) {
        ...
        String formatted = DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(appollolllaunch);
        System.out.println(formatted);

        DateTimeFormatter formatter = DateTimeFormatter.ofLocalizedDateTime(FormatStyle.FULL);
        formatted = formatter.format(appollolllaunch);
        System.out.println(formatted);

        formatted = formatter.withLocale(Locale.FRENCH).format(appollolllaunch);
        System.out.println(formatted);
        ...
        appollolllaunch = ZonedDateTime.parse("1969-01-16 03:32:00-0400"
