...
class RetireFrame extends JFrame{
    ...
    public void setCurrentLocale(Locale locale){
        ...
        res = ResourceBundle.getBundle("com.hoo.international.RetireResources",currentLocale);
        resStrings = ResourceBundle.getBundle("com.hoo.international.RetireResources",currentLocale);
    ...
    private void updateDisplay(){
        ...
        currentAgeField.setText(resStrings.getString("currentAge"));
